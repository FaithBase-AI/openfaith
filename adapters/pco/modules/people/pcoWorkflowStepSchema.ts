...
export const PcoWorkflowStepAttributes = Schema.Struct({
  auto_snooze_days: Schema.Number.annotations({ [OfFieldName]: 'autoSnoozeDays' }),
  auto_snooze_interval: Schema.String.annotations({ [OfFieldName]: 'autoSnoozeInterval' }),
  auto_snooze_value: Schema.Number.annotations({ [OfFieldName]: 'autoSnoozeValue' }),
  created_at: Schema.String.annotations({ [OfFieldName]: 'createdAt' }),
  default_assignee_id: Schema.String.annotations({ [OfFieldName]: 'defaultAssigneeId' }),
  ...
  my_ready_card_count: Schema.Number.annotations({ [OfFieldName]: 'myReadyCardCount' }),
  name: Schema.String.annotations({ [OfFieldName]: 'name' }),
  sequence: Schema.Number.annotations({ [OfFieldName]: 'sequence' }),
  total_ready_card_count: Schema.Number.annotations({ [OfFieldName]: 'totalReadyCardCount' }),
