...
[Reference](attachment_type_group.md)
...
[# Example Request](#/apps/services/2018-11-01/vertices/attachment_type_group#example-request)

```
curl https://api.planningcenteronline.com/services/v2/attachment_type_groups
```

[View in API Explorer](https://api.planningcenteronline.com/explorer/services/v2/attachment_type_groups)

[# Example Object](#/apps/services/2018-11-01/vertices/attachment_type_group#example-object)
...
[# Attributes](#/apps/services/2018-11-01/vertices/attachment_type_group#attributes)
...
[# URL Parameters](#/apps/services/2018-11-01/vertices/attachment_type_group#url-parameters)
...
[# Endpoints](#/apps/services/2018-11-01/vertices/attachment_type_group#endpoints)
