...
import {
  ...
  HoverCardContent,
  HoverCardTrigger,
} from '@openfaith/ui/components/ui/hover-card'
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
  InputGroupTextarea,
} from '@openfaith/ui/components/ui/input-group'
import {
  Select,
  SelectContent,
  SelectItem,
...
export function PromptInputProvider({
  ...
  const [attachements, setAttachements] = useState<Array<FileUIPart & { id: string }>>([])
