...
> = {
  ...
  icon: LucideIcon
  type: TType
  options?: TType extends OptionBasedColumnDataType ? Array<ColumnOption> : never
...
export type ColumnProperties<_TData, TVal> = {
  getOptions: () => Array<ColumnOption>
  getValues: () => Array<ElementType<NonNullable<TVal>>>
...
export type ColumnPrivateProperties<_TData, TVal> = {
  _prefetchedOptionsCache: Array<ColumnOption> | null
  _prefetchedValuesCache: Array<ElementType<NonNullable<TVal>>> | null
