...
export const TxtIcon: FC<TxtIconProps> = ({ className, width = 40, height = 40 }) => {
  return (
    <svg
      className={className}
      height={height}
    ...
    >
      <path
        ...
        style={{ fill: '#E2E5E7' }}
      />
      <path d='M384,128h96L352,0v96C352,113.6,366.4,128,384,128z' style={{ fill: '#B0B7BD' }} />
      <polygon points='480,224 384,128 480,128 ' style={{ fill: '#CAD1D8' }} />
      <path
